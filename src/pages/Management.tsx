          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-8">
              ...
              <div className="bg-white border rounded-3xl p-8">
                ...
                {/* <LesMerButton
                  title={info_data.management.title_2_les_mer}
                  content={info_data.management.content_2_les_mer}
                /> */}
              </div>
            </div>
            <div className="space-y-8">
              <div className="bg-white border rounded-3xl p-8">
                <h2>{info_data.management.title_3}</h2>
                <p style={{ whiteSpace: "pre-line" }}>
                  {info_data.management.content_3}
                </p>
                {/* <LesMerButton
