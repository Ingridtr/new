        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-full">
            ...
            <div className="space-y-6 text-center lg:text-left">
              <header>Lær matematikk gjennom fysisk aktivitet</header>
              <p>
              ...
              <div className="pt-4">
                <a
                  href="/Grade"
                  className="inline-flex items-center justify-center bg-sky-200 hover:bg-sky-300font-bold rounded-xl px-8 py-4  transition-colors min-w-[200px] min-h-[80px]"
                >
                  Hopp i gang!
                </a>
              </div>
